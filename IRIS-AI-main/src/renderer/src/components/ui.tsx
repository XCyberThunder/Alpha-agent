...
/**
 * ALPHA — All-in-one UI components file.
 *
 * This single file contains every shadcn/ui component actually used by the
 * ALPHA editor, plus the useToast hook. Previously these lived as separate
 * files in /src/components/ui/ and /src/hooks/use-toast.ts.
 *
 * Exports:
 *   Popover, PopoverTrigger, PopoverContent, PopoverAnchor
 *   ResizablePanelGroup, ResizablePanel, ResizableHandle
 *   ToastProvider, ToastViewport, Toast, ToastTitle, ToastDescription,
 *   ToastClose, ToastAction, ToastProps, ToastActionElement
 *   Toaster
 *   useToast, toast
 */
