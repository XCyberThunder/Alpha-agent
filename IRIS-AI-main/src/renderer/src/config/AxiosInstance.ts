...
AxiosInstance.interceptors.response.use(
  ...
  async (error: AxiosError) => {
    ...
    if (
      ...
      try {
        const currentRefreshToken = localStorage.getItem('alpha_cloud_token')
        ...
        if (res.data.refreshToken) {
          localStorage.setItem('alpha_cloud_token', res.data.refreshToken)
        }
        ...
        localStorage.removeItem('alpha_cloud_token')
